...
const SubmissionPreview: NextPage = () => {
  ...
  return (
    <div className='flex flex-col justify-between grow hover:bg-[#F2DAFB] bg-[#FCF1FF] mb-6 pb-8 px-6 rounded-lg'>
      ...
      <div className="text-xs flex justify-center">
        <div className="flex items-center bg-[#8C15B7] text-white rounded-[12px] mb-6 px-4 py-2">
